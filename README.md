...
<p><img src="./img/got_network.jpeg" style="width: 550px"></p>
...
```
    ...
    C:\Users\212462850\AppData\Local\Continuum\miniconda3\lib\site-packages\pandas\plotting\_core.py:1716: UserWarning: Pandas doesn't allow columns to be created via a new attribute name - see https://pandas.pydata.org/pandas-docs/stable/indexing.html#attribute-access
      series.name = label
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x20956a62f60>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x20956a6c908>
...
```
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x20957f46710>
